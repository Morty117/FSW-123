function About(){
    return(
        <div className="about-main">
            ...
            As the series progresses, Yugi and his friends learn that this person inside of his puzzle is actually the spirit of a nameless Pharaoh from Ancient Egyptian times, who had lost his memories. As Yugi and his companions attempt to help the Pharaoh regain his memories, they find themselves going through many trials as they wager their lives facing off against gamers that wield the mysterious Millennium Items and the dark power of the Shadow Games.</p>
            <a href="https://en.wikipedia.org/wiki/Yu-Gi-Oh!">All history was pulled from here</a>
        </div>
    )
}
